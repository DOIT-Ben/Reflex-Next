...
| P1-004 | 冻结重试、超时、取消和错误分类 | 进行中 | P0-003 | OpenAI-compatible 已完成；MiniMax 与阻塞读取主动取消待补 |
| P1-005 | 增强 SSE/JSON 断流与超大响应防护 | 进行中 | P1-004 | OpenAI-compatible 已完成 2 MiB/50,000 上限与终态测试；MiniMax 待补 |
...
- Python：9 个包共 524 项测试通过；
- Rust/Tauri Host：139 项通过，2 项需要真实 Windows Credential Manager；
