...
- 前端架构重构：App.svelte 从 2851 行拆解至约 1900 行，全部功能流下沉为
  `domain/` 下的可注入、可单测控制器（翻译、Markdown 预览、批处理、模板、
  语义模型、设置、云隐私、诊断包、剪贴板、反馈、首启激活、优化主链、
  toast、视图缩放、下载助手），并新增架构测试守护分层与行数预算；
